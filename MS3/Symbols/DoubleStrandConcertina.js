...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
    ...
    function (declare, lang, Array,
        ...
        var DoubleStrandConcertina = declare([Evented], {
            declaredClass: "MilitarySymbology.Symbols.DoubleStrandConcertina",
            SID: "290308",
            symName: "Wire Obs - Double Strand Concertina",
            ...
            createSymbol: function (drawEssentials) {
                try {
                    ...
                    for (var i = 0; i < resPts.length; i++) {
                        echelons = Shapes.createEchelon('120', resPts[i], cLenLimit);
                    ...
                    var p1 = { x: partialLen * Math.cos(k) + firstPoint.x, y: partialLen * Math.sin(k) + firstPoint.y };
                    var p2 = { x: -1 * partialLen * Math.cos(k) + firstPoint.x, y: -1 * partialLen * Math.sin(k) + firstPoint.y };
                    ...
                    for (i = 0; i < pts.length; i++) {
                        ...
                        var length = GeoTools._2PtLen(firstPoint, pts[i]);
                        var angle = GeoTools.angleInRadians(firstPoint, pts[i]);
