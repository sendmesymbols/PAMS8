...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
    ...
    function (declare, lang, Array,
        ...
        var StartLine = declare([Evented], {
            declaredClass: "MilitarySymbology.Symbols.StartLine",
            SID: "140303",
            symName: "Start Line",
            ...
            createSymbol: function (drawEssentials) {
                try {
                    ...
                    var paths = Shapes.createSL(pt1.x, pt1.y, len / 2, map.spatialReference);
                    ...
                    var paths = Shapes.createSL(pt2.x, pt2.y, len / 2, map.spatialReference);
                    for (var i = 0; i < paths.length; i++) {
                        result.addPath(paths[i]);
                    }
