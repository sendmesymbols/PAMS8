/**
 * Class Representing Corps Line Of Denial.
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
	...
	function (declare, lang, Array,
		...
		var CLineOfDenial = declare([Evented], {
			declaredClass: "MilitarySymbology.Symbols.CLineOfDenial",
			SID: "141800",
			symName: "Corps Line of Denial",
			...
			createSymbol: function (drawEssentials) {
				try {
					...
					var paths = Shapes.createCLD(pt1.x, pt1.y, len / 2, map.spatialReference);
					...
					var paths = Shapes.createCLD(pt2.x + (len / 1.5), pt2.y, len / 2, map.spatialReference);
					for (var i = 0; i < paths.length; i++) {
						result.addPath(paths[i]);
					}
