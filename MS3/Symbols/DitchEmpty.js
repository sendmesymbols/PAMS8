/**
 * Class Representing Ditch Empty.
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
    ...
    function (declare, lang, Array,
        ...
        var DitchEmpty = declare([Evented], {
            declaredClass: "MilitarySymbology.Symbols.DitchEmpty",
            SID: "290201",
            symName: "DCB",
            ...
            init: function (options, marker) {
                ...
                /*
                var sfs = new SimpleFillSymbol(SimpleFillSymbol.STYLE_SOLID, new SimpleLineSymbol(SimpleLineSymbol.SOLID,  new color([255,0,0]), 2),new color([0,255,0,1]));
                this._lineSym = sfs;
                */



                this._lineSym.setColor(new color([0, 0, 0, 1]));
                ...
                if (options.hasOwnProperty("CTRL_PTS") && options.hasOwnProperty("GEOM")) {
                    ...
                    drawEssentials = this.createDrawEssentials(lang.clone(options.CTRL_PTS), this._teethSize, this._teethGap);
            ...
            createDrawEssentials: function (ctrlPts, teeth_size, teeth_gap) {
                var drawEssentials = new DrawEssentials();
