/**
 * Class Representing Attack Position.
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var AttackPosition = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.AttackPosition",
      SID: "151600",
      symName: "Attk Posn",
      ...
      createInnerText: function (result, firstPoint, lastPoint) {
        ...
        try {
          ...
          var catk = Shapes.CATK(midPt.x, midPt.y, cLenLimit, midPt.spatialReference);
          for (var j = 1; j <= catk.length - 1; j++) {
            res.addRing(catk[j]);
          }
          return res;
        } catch (e) {
