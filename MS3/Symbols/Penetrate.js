...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
	...
	function (declare, lang, Array,
		...
		var Penetrate = declare([Evented], {
			declaredClass: "MilitarySymbology.Symbols.Penetrate",
			SID: "341800",
			symName: "Penetrate",
			...
			createSymbol: function (drawEssentials) {
				try {
					...
					//Arrow Head
					result.addPath(Shapes.arrowHeadBackward(midPt, GeoTools.ArrowFlanksLen(GeoTools._2PtLen(midPt, pts[pts.length - 1]), GeoTools._2PtLen(stPtCandidatePt, endPtCandidatePt)),
