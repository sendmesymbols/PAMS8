define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
    ...
    function (declare, lang, Array,
        ...
        var TacticalPointText = declare([Evented], {
            declaredClass: "MilitarySymbology.Symbols.TacticalPointText",
            SIC: "000110",
            symName: "TacticalPointText",
            ...
            init: function (options, marker, sic, symName, offset, sidc) {
                ...
                if (this._path.length === undefined) {
                    ...
                    if(options.hasOwnProperty('opacity')) {
                        this._ptSymbol.color.a = options.opacity;
                    }
                    ...
                    if (options.hasOwnProperty("GEOM")) {
                        ...
                        drawEssentials = this.createDrawEssentials(lang.clone(options.GEOM), lang.clone(options.SIZE), lang.clone(options.ANGLE), this._opacity);
            ...
            createDrawEssentials: function (geom, size, angle, opacity) {
                var drawEssentials = new DrawEssentials();
            ...
            cleanUp: function () {
                ...
                drawEss = this.createDrawEssentials(lang.clone(this._point), this._ptSymbol.size, this._ptSymbol.angle, this._opacity);

                this._ptSymbol.setColor(new color([255, 255, 255, this._opacity]));
                this._ptSymbol.setOutline(null);
