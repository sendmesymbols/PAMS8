        ...
        var EditEngine = declare([Evented], {
            ...
            removeCtrlPtsFromAttribs : function(graphic, emit) {
                ...
                if (graphic.attributes.hasOwnProperty('tempBpoints')) {
                    if (graphic.attributes.tempBpoints.hasOwnProperty('startPt')) graphic.drawEssentials.BASE_LN_PTS.startPt = graphic.attributes.tempBpoints.startPt;
                    if (graphic.attributes.tempBpoints.hasOwnProperty('endPt')) graphic.drawEssentials.BASE_LN_PTS.endPt = graphic.attributes.tempBpoints.endPt;
                    if (graphic.attributes.tempBpoints.hasOwnProperty('midPt')) graphic.drawEssentials.BASE_LN_PTS.midPt = graphic.attributes.tempBpoints.midPt;
