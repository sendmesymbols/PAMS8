/**
 * Class Representing Bridgehead Line.
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
    ...
    function (declare, lang, Array,
        ...
        var BridgeHeadLine = declare([Evented], {
            declaredClass: "MilitarySymbology.Symbols.BridgeHeadLine",
            SID: "141400",
            symName: "Bridgehead Line",
            ...
            createSymbol: function (drawEssentials) {
                try {
                    ...
                    var paths = Shapes.createBL(pt1.x, pt1.y, len / 2, map.spatialReference);
                    ...
                    var paths = Shapes.createBL(pt2.x, pt2.y, len / 2, map.spatialReference);
                    for (var i = 0; i < paths.length; i++) {
                        result.addPath(paths[i]);
                    }
