/**
 * Class Representing Named Area of Interest.
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var NamedAreaOfInterest = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.NamedAreaOfInterest",
      SID: "120200",
      symName: "Named Area of Interest",
      ...
      createInnerText: function (result, firstPoint, lastPoint) {
        ...
        try {
          ...
          var catk = Shapes.createNAI(midPt.x, midPt.y, cLenLimit, midPt.spatialReference);
          for (var j = 0; j <= catk.length - 1; j++) {
            res.addRing(catk[j]);
          }
          return res;
        } catch (e) {
