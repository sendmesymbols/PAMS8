...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var Occupy = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.Occupy",
      SID: "341700",
      symName: "Occupy",
        ...
        try {
          ...
          if (pts.length === 2) {
            ...
            if (circle.radius > 0) {
              ...
              result.addPath(Shapes.createO(cPoint.x, cPoint.y, cLenLimit, this.map.spatialReference));
              ...
              var innerWingPlus = new Point(-1 * length * Math.cos(angle) + endPt.x, -1 * length * Math.sin(angle) + endPt.y, this.map.spatialReference);
              ...
              var outerWingPlus = new Point(-1 * length * Math.cos(angle) + endPt.x, -1 * length * Math.sin(angle) + endPt.y, this.map.spatialReference);
