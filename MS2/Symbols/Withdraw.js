...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var Withdraw = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.Withdraw",
      SID: "342400",
      symName: "Withdraw",
        ...
        try {
          ...
          if (pts.length === 2) {
            ...
            for (var i = 0; i < values.midPoints.length; i++) {
              ...
              result.addPath(Shapes.createW(values.midPoints[i].midPt.x, values.midPoints[i].midPt.y, cLenLimit, this.map.spatialReference));
