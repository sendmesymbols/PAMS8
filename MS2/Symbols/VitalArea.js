...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var VitalArea = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.VitalArea",
      SID: "242303",
      symName: "Vital Area",
      ...
      createInnerText: function (result, firstPoint, lastPoint) {
        ...
        try {
          ...
          var va = Shapes.createVA(midPt.x, midPt.y, cLenLimit, midPt.spatialReference);
          for (var j = 0; j <= va.length - 1; j++) {
            res.addRing(va[j]);
          }
