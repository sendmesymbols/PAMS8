...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
	...
	function (declare, lang, Array,
		...
		var Disrupt = declare([Evented], {
			declaredClass: "MilitarySymbology.Symbols.Disrupt",
			SID: "341000",
			symName: "Disrupt",
			...
			createSymbol: function (drawEssentials) {
				try {
					...
					for (i = 0; i < pts.length; i++) {
						...
						var shortenLeftPt = { x: -1 * length / 5 * Math.cos(k) + stPtCandidatePt.x, y: -1 * length / 5 * Math.sin(k) + stPtCandidatePt.y };
