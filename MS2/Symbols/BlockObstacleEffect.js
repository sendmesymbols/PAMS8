/**
 * Class Representing Block Obstacle Effect.
 *
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
	...
	function (declare, lang, Array,
		...
		var BlockObstacleEffect = declare([Evented], {
			declaredClass: "MilitarySymbology.Symbols.BlockObstacleEffect",
			SID: "270501",
			symName: "Block / Obstacle Effect",
		 ...
		 */
			...
			baseLineDrawEnd: function (evt) {
				...
				this.emit("onBaseLineDrawEnd", {
					"currentPts": evt.geometry.controlPoints
				});
