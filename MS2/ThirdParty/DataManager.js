...
define(["esri/SpatialReference",  "esri/geometry/Extent" ], 
  function(SpatialReference, Extent) {
    
    return {
        rawData : [],

        fakeServerSideClustering:  function(clusterRatio, maxSingleFlareCount, areaDisplayMode, map) {
        ...
        for (var i = 0; i < xCount; i++) {
            ...
            for (var j = 0; j < yCount; j++) {
                ...
                ext.setSpatialReference(new SpatialReference({ "wkid": 4326 }));
                clusters.push({
                    extent: ext,
                    clusterCount: 0,
                    subTypeCounts: [],
