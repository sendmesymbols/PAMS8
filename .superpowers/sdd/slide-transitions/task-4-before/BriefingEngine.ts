...
class BriefingEngine {
  ...
  private async _transitionPresentOverlays(
    ...
    newEl.style.zIndex = '41'; // must beat the .ms-briefing-overlay-canvas class's z-index:40 (line ~2125), or the incoming frame paints BELOW the outgoing one and 'wipe' never becomes visible
