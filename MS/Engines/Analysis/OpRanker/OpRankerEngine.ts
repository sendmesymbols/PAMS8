...
export class OpRankerEngine {
  ...
  private _injectStyles(): void {
    ...
    style.textContent = `
      ...
      #oprank-hint{position:fixed;bottom:55px;left:50%;transform:translateX(-50%);background:var(--ms-bg-header,rgba(26,32,48,.97));border:1px solid rgba(55,138,221,.45);color:#378ADD;font-family:var(--ms-font,'SF Pro Display','Segoe UI',system-ui,sans-serif);font-size:var(--ms-fs);letter-spacing:.08em;padding:9px 22px;border-radius:4px;pointer-events:none;z-index:1100;text-transform:uppercase;display:none;font-weight:600}
