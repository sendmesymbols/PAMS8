...
export class LocalPeaksEngine {
  ...
  private _injectStyles(): void {
    ...
    style.textContent = `
      .peaks-panel{--ms-bg:#141820;--ms-bg-header:rgba(26,32,48,.97);--ms-bg-input:rgba(0,0,0,.28);--ms-border:rgba(90,140,220,.25);--ms-divider:rgba(80,100,150,.18);--ms-text:#dce8f5;--ms-text-dim:rgba(175,200,230,.82);--ms-text-label:rgba(140,170,205,.85);--ms-radius:9px;--ms-shadow:0 8px 36px rgba(0,0,0,.55),inset 0 0 0 1px rgba(255,255,255,.04);--ms-font:'SF Pro Display','Segoe UI',system-ui,sans-serif;--ms-fs:13.5px;--ms-fs-sm:15px;--ms-fs-xs:11.5px;position:fixed;top:62px;left:306px;width:380px;max-height:calc(100vh - 84px);background:var(--ms-bg);border:1px solid var(--ms-border);border-radius:var(--ms-radius);color:var(--ms-text);font-family:var(--ms-font);font-size:var(--ms-fs);z-index:1100;box-shadow:var(--ms-shadow);display:none;overflow:hidden;user-select:none;animation:peaksIn .18s cubic-bezier(.34,1.56,.64,1)}
      @keyframes peaksIn{from{opacity:0;transform:scale(.96) translateY(-8px)}to{opacity:1;transform:scale(1) translateY(0)}}
      .peaks-header{display:flex;align-items:center;gap:7px;padding:9px 10px 8px;border-bottom:1px solid var(--ms-divider);background:var(--ms-bg-header);cursor:grab}.peaks-header:active{cursor:grabbing}.peaks-header-icon{font-size:10.5px;letter-spacing:.08em;color:#EF9F27;border:1px solid var(--ms-border);border-radius:3px;padding:2px 5px;font-weight:700}.peaks-header-title{font-size:16px;letter-spacing:.12em;text-transform:uppercase;color:#EF9F27;font-weight:700;flex:1}.peaks-status-dot{width:9px;height:9px;border-radius:50%;background:#555}.peaks-status-lbl{font-size:11.5px;letter-spacing:.08em;text-transform:uppercase;color:var(--ms-text-dim);min-width:48px;font-weight:600}.peaks-help-btn,.peaks-min-btn,.peaks-close-btn{background:none;border:1px solid transparent;color:var(--ms-text-dim);font-size:15px;cursor:pointer;padding:0 4px}.peaks-help-btn{width:21px;height:21px;border-color:var(--ms-border);border-radius:50%;color:#1D9E75;font-weight:700;font-size:13px}
      .peaks-panel *{scrollbar-width:thin;scrollbar-color:rgba(239,159,39,.55) rgba(0,0,0,.18)}
      .peaks-panel *::-webkit-scrollbar{width:6px;height:6px}
      .peaks-panel *::-webkit-scrollbar-track{background:rgba(0,0,0,.18);border-radius:3px}
      .peaks-panel *::-webkit-scrollbar-thumb{background:linear-gradient(180deg,rgba(239,159,39,.55),rgba(29,158,117,.55));border-radius:3px;border:1px solid rgba(0,0,0,.25)}
      .peaks-panel *::-webkit-scrollbar-thumb:hover{background:linear-gradient(180deg,rgba(239,159,39,.85),rgba(29,158,117,.75))}
      .peaks-panel *::-webkit-scrollbar-corner{background:transparent}
      .peaks-body{max-height:calc(100vh - 122px);overflow-y:auto;padding:0 0 8px}.peaks-status-msg{margin:9px 12px 2px;padding:7px 9px;border:1px solid var(--ms-divider);border-radius:4px;background:var(--ms-bg-input);font-size:12.5px;line-height:1.4;color:var(--ms-text-dim)}.peaks-status-msg.running{color:#EF9F27}.peaks-status-msg.warn{color:#DC3C30;border-color:#DC3C30}.peaks-status-msg.pick{color:#378ADD;border-color:#378ADD}.peaks-status-msg.done,.peaks-status-msg.ready{color:#1D9E75}.peaks-sec{font-size:12px;letter-spacing:.12em;text-transform:uppercase;color:#EF9F27;font-weight:700;padding:11px 14px 6px}.peaks-grid{display:grid;grid-template-columns:1fr 1fr;gap:9px 10px;padding:0 12px 9px}.peaks-field{display:flex;flex-direction:column;gap:4px}.peaks-field.full{grid-column:1/-1}.peaks-field.sort{padding:0 12px 8px}.peaks-field span,.peaks-toggle label{font-size:11.5px;letter-spacing:.07em;text-transform:uppercase;color:var(--ms-text-label);font-weight:600}.peaks-field input,.peaks-field select,.peaks-grid select,.peaks-grid input{background:var(--ms-bg-input);border:1px solid var(--ms-border);border-radius:4px;color:var(--ms-text);font-family:inherit;font-size:13.5px;padding:7px 9px;outline:none;box-sizing:border-box;width:100%}.peaks-field input:focus,.peaks-field select:focus{border-color:#EF9F27}.peaks-field select option{background:var(--ms-bg)}
      .peaks-btn-row{display:flex;gap:7px;padding:7px 12px 0}.peaks-btn{flex:1;padding:8px 5px;font-family:inherit;font-size:11.5px;letter-spacing:.06em;text-transform:uppercase;font-weight:600;cursor:pointer;border-radius:4px;border:1px solid var(--ms-border);background:var(--ms-bg-input);color:var(--ms-text-dim);transition:all .14s}.peaks-btn:hover:not(:disabled){background:var(--ms-bg-header);color:var(--ms-text)}.peaks-btn.primary{border-color:#EF9F27;color:#EF9F27;font-weight:700}.peaks-btn:disabled{opacity:.35;cursor:not-allowed}.peaks-toggle{display:flex;align-items:center;justify-content:space-between;padding:6px 14px}.peaks-toggle input{accent-color:#EF9F27;width:15px;height:15px;cursor:pointer}.peaks-progress{padding:9px 12px 3px}.peaks-progress>div{height:6px;background:var(--ms-bg-input);border-radius:3px;overflow:hidden;border:1px solid var(--ms-divider)}#peaks-progress-fill{height:100%;width:0;background:linear-gradient(90deg,#1D9E75,#EF9F27);transition:width .16s}#peaks-progress-label{display:block;margin-top:5px;font-size:11.5px;color:var(--ms-text-dim);letter-spacing:.04em}.peaks-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;padding:0 12px 9px}.peaks-stats div{background:var(--ms-bg-input);border:1px solid var(--ms-divider);border-radius:4px;padding:7px 9px}.peaks-stats span{display:block;font-size:10.5px;text-transform:uppercase;color:var(--ms-text-label);letter-spacing:.06em;font-weight:600}.peaks-stats b{display:block;margin-top:3px;font-size:16px;color:var(--ms-text);white-space:nowrap;font-weight:700}
      .peaks-results{max-height:280px;overflow-y:auto;padding:0 12px}.peaks-empty{padding:18px 10px;color:var(--ms-text-dim);font-size:12.5px;line-height:1.5;text-align:center;border:1px dashed var(--ms-divider);border-radius:4px}.peaks-row{border:1px solid var(--ms-divider);border-radius:5px;background:var(--ms-bg-input);padding:9px 11px;margin-bottom:8px;cursor:pointer}.peaks-row:hover,.peaks-row.selected{border-color:#EF9F27;background:var(--ms-bg-header)}.peaks-row-main{display:flex;align-items:center;gap:7px}.peaks-row-main b{color:#EF9F27}.peaks-row-main span{font-size:var(--ms-fs-xs);color:var(--ms-text-dim)}.peaks-row-metrics{display:flex;gap:8px;flex-wrap:wrap;margin-top:4px;font-size:var(--ms-fs-xs);color:var(--ms-text)}.peaks-row-actions{display:flex;gap:5px;margin-top:5px}.peaks-row-actions button{flex:1;border:1px solid var(--ms-border);background:transparent;color:var(--ms-text-dim);border-radius:3px;font-size:10px;cursor:pointer}.peaks-row-actions button:hover{color:#EF9F27;border-color:#EF9F27}
      ...
      .peaks-row-header{display:flex;align-items:center;gap:9px;margin-bottom:7px}.peaks-row-badge{display:inline-flex;align-items:center;padding:4px 10px;border-radius:4px;font-size:13px;font-weight:700;color:#fff;white-space:nowrap;min-width:46px;justify-content:center;letter-spacing:.03em}.peaks-row-elev{font-size:18px;font-weight:700;color:var(--ms-text);letter-spacing:.01em}.peaks-row-unit{font-size:12px;font-weight:500;color:var(--ms-text-dim)}.peaks-row-btns{display:flex;gap:5px;margin-left:auto}.peaks-row-btns button{padding:5px 10px;border:1px solid var(--ms-border);background:transparent;color:var(--ms-text-dim);border-radius:4px;font-size:11px;cursor:pointer;transition:all .12s;font-weight:600;letter-spacing:.04em}.peaks-row-btns button:hover{color:#EF9F27;border-color:#EF9F27}.peaks-row-bar-wrap{height:4px;background:rgba(255,255,255,0.06);border-radius:2px;overflow:hidden;margin-bottom:8px}.peaks-row-bar{height:100%;border-radius:2px;transition:width .2s}.peaks-row-metrics{display:flex;gap:14px;flex-wrap:wrap;font-size:12.5px;color:var(--ms-text);font-weight:600}.peaks-lbl{font-size:10.5px;text-transform:uppercase;letter-spacing:.07em;color:var(--ms-text-label);margin-right:3px;font-weight:600}.peaks-row-coord{font-size:11px;color:var(--ms-text-label);margin-top:5px;font-family:'SF Mono','Consolas',monospace;letter-spacing:.03em}
