 ...
 */
export class AntiPersonnelMineDirEffct {
    ...
    // Symbol properties
    private SID: string = "270702";
    private symName: string = "Minefield - Antipersonnel Mine with Directional Effects";
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "AntiPersonnelMineDirEffct");
     ...
     */
    public init(options: AntiPersonnelMineDirEffctOptions, marker: SimpleLineSymbol): void {
        this._opacity = 1;
        ...
        try {
            ...
            this._lineSym = new SimpleFillSymbol({
                style: "solid",
                color: [255, 140, 0, this._opacity], // Dark orange color for directional mines
                outline: marker
            });
        }
    ...
    private getImagePath(): string {
        ...
        const imageName = 'AntiPersonnelMineDirEffct.png';
