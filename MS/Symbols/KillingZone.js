...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var KillingZone = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.KillingZone",
      SID: "242302",
      symName: "Killing Zone",
      ...
      createInnerText: function (result, firstPoint, lastPoint) {
        ...
        try {
          ...
          var kz = Shapes.createKZ(midPt.x, midPt.y, cLenLimit, midPt.spatialReference);
          for (var j = 0; j <= kz.length - 1; j++) {
            res.addRing(kz[j]);
          }
