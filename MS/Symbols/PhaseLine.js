...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
    ...
    function (declare, lang, Array,
        ...
        var PhaseLine = declare([Evented], {
            declaredClass: "MilitarySymbology.Symbols.PhaseLine",
            SID: "140300",
            symName: "Phase Line",
            ...
            createSymbol: function (drawEssentials) {
                try {
                    ...
                    var paths = Shapes.createPL(pt1.x, pt1.y, len / 2, map.spatialReference);
                    ...
                    var paths = Shapes.createPL(pt2.x, pt2.y, len / 2, map.spatialReference);
                    for (var i = 0; i < paths.length; i++) {
                        result.addPath(paths[i]);
                    }
