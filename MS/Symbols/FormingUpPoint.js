...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var FormingUpPoint = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.FormingUpPoint",
      SID: "140302",
      symName: "FUP",
      ...
      createSymbolByPerfectEllipse: function (pts, firstPoint, lastPoint, drawEssentials) {
        ...
        cLenLimit = GeoTools._2PtLen(firstPoint, lastPoint) / 10;

        var text = Shapes.createFUP(centerPt.x, centerPt.y, cLenLimit, centerPt.spatialReference);
