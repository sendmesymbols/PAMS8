...
export interface CounterAttkObjOptions {
    CTRL_PTS?: Point[];
    GEOM?: Polyline;
    DRAW_TYPE?: number;
    [key: string]: any;
...
/**
 * CounterAttkObj class for drawing Counter Attack Objective symbols on MapView or SceneView
 * Supports both immediate placement and interactive drawing modes
 */
export class CounterAttkObj {
    ...
    // Symbol properties
    private SID: string = "140301";
    private symName: string = "Counter Attk Obj";
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "CounterAttkObj");
    ...
    /**
     * Initialize the counter attack objective drawing
     */
    public init(options: CounterAttkObjOptions, marker: SimpleLineSymbol | SimpleFillSymbol): void {
