...
/**
 * Cover class for drawing Phase Line symbols on MapView or SceneView
 * Creates line symbol
 */
export class Cover {
  ...
  constructor(view: MapView | SceneView, isLine: boolean = false) {
    ...
    this.events = new SymbolEvents(view, "Cover");
   ...
   */
  public init(options: CoverOptions, marker: SimpleLineSymbol | SimpleFillSymbol): void {
  ...
  private _onClickHandler(clickEvent: any): void {
    ...
    // For Cover, finish after 3 points (legacy behavior)
  ...
  private createSymbol(drawEssentials: DrawEssentials): Polyline | null {
    try {
      ...
      const cPts = (Shapes as any).createCC(cPt.x, cPt.y, cLenLimit, spatialReference) as Point[];
      if (cPts && cPts.length) {
