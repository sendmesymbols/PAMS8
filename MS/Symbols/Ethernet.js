...
define(["dojo/_base/declare", "dojo/_base/lang", "esri/graphic", "esri/geometry/jsonUtils",
    ...
    function (declare, lang, _Graphic, jsonUtility,
        ...
        var Ethernet = declare([Evented], {
            declaredClass: "MilitarySymbology.Symbols.Ethernet",
            SID: "150209",
            symName: "Ethernet",
            ...
            createSymbol: function (drawEssentials) {
                try {
                    ...
                    for (var i = 0; i < values.midPoints.length; i++) {
                      ...
                      result.addPath(Shapes.createE(values.midPoints[i].midPt.x, values.midPoints[i].midPt.y, cLenLimit, this.map.spatialReference));
