...
export interface ObstacleLineOptions {
    CTRL_PTS?: Point[];
    GEOM?: Polyline;
    DRAW_TYPE?: number;
    [key: string]: any;
...
/**
 * ObstacleLine — a line (straight or curved, per DRAW_TYPE) carrying outward-pointing
 * triangular teeth along its length ( ▁/\▁/\▁ ). Teeth follow the local line direction so
 * they work for both draw types. Rendered green (obstacle). Single Polyline geometry.
 */
export class ObstacleLine {
    ...
    // Symbol properties
    public declaredClass: string = "MilitarySymbology.Symbols.ObstacleLine";
    private SID: string = "290100";
    private symName: string = "Obstacle Line";
    ...
    private _toothSide: number = 1; // +1 / -1: which side of the line the apexes point
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "ObstacleLine");
    ...
    /**
     * Initialize the obstacle line drawing
     */
    public init(options: ObstacleLineOptions, marker: SimpleLineSymbol | SimpleFillSymbol): void {
