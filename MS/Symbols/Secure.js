...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var Secure = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.Secure",
      SID: "342100",
      symName: "Secure",
        ...
        try {
          ...
          if (pts.length === 2) {
            ...
            if (circle.radius > 0) {
              ...
              result.addPath(Shapes.createS(cPoint.x, cPoint.y, cLenLimit, this.map.spatialReference));
