/**
 * Class Representing Withdraw Under Pressure.
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var WithdrawUnderPressure = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.WithdrawUnderPressure",
      'SID': "342500",
      'symName': "Withdraw Under Pressure",
        ...
        try {
          ...
          if (pts.length === 2) {
            ...
            for (var i = 0; i < values.midPoints.length; i++) {
              ...
              var paths = Shapes.createWP(values.midPoints[i].midPt.x, values.midPoints[i].midPt.y, cLenLimit, this.map.spatialReference);
              ...
              //result.addPath(Shapes.createWP(values.midPoints[i].midPt.x, values.midPoints[i].midPt.y , cLenLimit, this.map.spatialReference));
