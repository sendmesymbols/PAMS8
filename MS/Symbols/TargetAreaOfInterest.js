...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var TargetAreaOfInterest = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.TargetAreaOfInterest",
      SID: "120201",
      symName: "Tgt Area of Interest",
      ...
      createInnerText: function (result, firstPoint, lastPoint) {
        ...
        try {
          ...
          var tiaTxt = Shapes.createTAI(midPt.x, midPt.y, cLenLimit, midPt.spatialReference);
          for (var j = 0; j <= tiaTxt.length - 1; j++) {
            res.addRing(tiaTxt[j]);
          }
          return res;
        } catch (e) {
