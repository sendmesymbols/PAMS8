...
export class CLineOfDenial {
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "CLineOfDenial");
    ...
    private createSymbol(drawEssentials: DrawEssentials): Polyline | null {
        try {
            ...
            // Add CLD markers
            this.addCLDMarkers(result, p1, p2);
    ...
    /**
     * Add CLD markers at both ends of the line
     */
    private addCLDMarkers(result: Polyline, p1: Point, p2: Point): void {
        try {
            ...
            console.log('Error adding CLD markers');
        }
    }
