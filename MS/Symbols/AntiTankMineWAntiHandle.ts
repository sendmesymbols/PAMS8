...
export interface AntiTankMineWAntiHandleOptions {
    CTRL_PTS?: Point[];
    GEOM?: Polygon;
    DRAW_TYPE?: number;
    opacity?: number;
...
/**
 * AntiTankMineWAntiHandle class for drawing Antitank Mine with Anti-handling Device symbols
 * Supports multiple drawing types: Bezier curve (1), Polygon (2), Rectangle (3)
 */
export class AntiTankMineWAntiHandle {
    ...
    // Symbol properties
    private SID: string = "270704";
    private symName: string = "Minefield - Antitank Mine with Anti-handling Device";
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "AntiTankMineWAntiHandle");
     ...
     */
    public init(options: AntiTankMineWAntiHandleOptions, marker: SimpleLineSymbol): void {
        this._opacity = 1;
    ...
    private getImagePath(): string {
        ...
        const imageName = 'AntiTankMineWAntiHandle.png';
...
export default AntiTankMineWAntiHandle; 