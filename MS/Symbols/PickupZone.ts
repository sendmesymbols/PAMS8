...
export interface PickupZoneOptions {
    CTRL_PTS?: Point[];
    GEOM?: Polygon;
    DRAW_TYPE?: number;
...
/**
 * PickupZone class for Pickup Zone symbol
 * Supports multiple drawing types: Bezier curve (1), Polygon (2), Rectangle (3)
 * Includes inner "PZ" text marker
 */
export class PickupZone {
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "PickupZone");
     ...
     */
    public init(options: PickupZoneOptions, marker: SimpleLineSymbol): void {
    ...
    /**
     * Create inner "PZ" text marker for Pickup Zone.
    ...
    private createInnerText(result: Polygon, firstPoint: Point, lastPoint: Point): Polygon {
        try {
            ...
            const rings = (Shapes as any).createPZRings
                ? (Shapes as any).createPZRings(midPt.x, midPt.y, cLenLimit, midPt.spatialReference)
                : null;
