...
export interface TargetAreaOfInterestOptions {
    CTRL_PTS?: Point[];
    GEOM?: Polygon;
    DRAW_TYPE?: number;
...
export class TargetAreaOfInterest {
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "TargetAreaOfInterest");
     ...
     */
    public init(options: TargetAreaOfInterestOptions, marker: SimpleLineSymbol): void {
