...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var KillingGr = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.KillingGr",
      SID: "242300",
      symName: "Killing Gr",
      ...
      createInnerText: function (result, firstPoint, lastPoint) {
        ...
        try {
          ...
          var kg = Shapes.createKG(midPt.x, midPt.y, cLenLimit, midPt.spatialReference);
          for (var j = 0; j <= kg.length - 1; j++) {
            res.addRing(kg[j]);
          }
