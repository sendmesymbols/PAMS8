...
export interface KillingZoneOptions {
    CTRL_PTS?: Point[];
    GEOM?: Polygon;
    DRAW_TYPE?: number;
    [key: string]: any;
...
export declare class KillingZone {
     ...
     */
    init(options: KillingZoneOptions, marker: SimpleLineSymbol): void;
    /**
