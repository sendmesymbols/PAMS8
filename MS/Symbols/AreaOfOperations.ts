...
export class AreaOfOperations {
    ...
    // Symbol properties
    private SID: string = "120100";
    private symName: string = "Area of Ops";
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "AreaOfOperations");
     ...
     */
    public init(options: AreaOfOperationsOptions, marker: SimpleLineSymbol): void {
