...
export interface SingleFenceWireOptions {
  CTRL_PTS?: Point[];
  GEOM?: Polyline;
  DRAW_TYPE?: number;
...
/**
 * SingleFenceWire class for Single Fence symbol
 */
export class SingleFenceWire {
  ...
  // Symbol metadata
  public declaredClass = "MilitarySymbology.Symbols.SingleFenceWire";
  public SID = "290302";
  public symName = "Wire Obs - Single Fence Wire";
  ...
  constructor(view: MapView | SceneView, isLine: boolean = false) {
    ...
    this.events = new SymbolEvents(view, "SingleFenceWire");
   ...
   */
  public init(options: SingleFenceWireOptions, marker: SimpleLineSymbol): void {
...
export default SingleFenceWire;