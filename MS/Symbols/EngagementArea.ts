...
export interface EngagementAreaOptions {
    CTRL_PTS?: Point[];
    GEOM?: Polygon;
    DRAW_TYPE?: number;
...
/**
 * EngagementArea class for Engagement Area symbol
 * Supports multiple drawing types: Bezier curve (1), Polygon (2), Rectangle (3)
 * Includes inner "EA" text marker
 */
export class EngagementArea {
    ...
    // Symbol properties
    public declaredClass = "MilitarySymbology.Symbols.EngagementArea";
    private SID: string = "25151300";
    private symName: string = "Engagement Area";
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "EngagementArea");
     ...
     */
    public init(options: EngagementAreaOptions, marker: SimpleLineSymbol): void {
    ...
    /**
     * Create inner "EA" text marker for Engagement Area.
    ...
    private createInnerText(result: Polygon, firstPoint: Point, lastPoint: Point): Polygon {
        try {
            ...
            const rings = (Shapes as any).createEARings
                ? (Shapes as any).createEARings(midPt.x, midPt.y, cLenLimit, midPt.spatialReference)
                : null;
