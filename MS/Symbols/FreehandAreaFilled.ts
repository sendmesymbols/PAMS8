 ...
 */
export class FreehandAreaFilled {
    ...
    // Symbol properties
    private SID: string = "000120";
    private symName: string = "Freehand - Area Filled";
     ...
     */
    public init(options: FreehandAreaFilledOptions, marker: SimpleLineSymbol): void {
        // Set opacity
        this._opacity = 0.50;
