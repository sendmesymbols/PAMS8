/**
 * Class Representing Avenue of Approaches.
 *
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
    ...
    function (declare, lang, Array,
        ...
        var AvenueOfApchs = declare([Evented], {
            declaredClass: "MilitarySymbology.Symbols.AvenueOfApchs",
            SID: "120204",
            symName: "Avenue of Approaches",
            ...
            createSymbol: function (drawEssentials) {
                try {
                    ...
                    if (pts.length <= 2) {
                        ...
                        ring = ring.concat([leftArray[0], rightArray[0]]);
