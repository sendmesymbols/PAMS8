...
export interface AntiPersonnelMineOptions {
    CTRL_PTS?: Point[];
    GEOM?: Polygon;
    DRAW_TYPE?: number;
    opacity?: number;
...
/**
 * AntiPersonnelMine class for drawing Antipersonnel Mine symbols
 * Supports multiple drawing types: Bezier curve (1), Polygon (2), Rectangle (3)
 */
export class AntiPersonnelMine {
    ...
    // Symbol properties
    private SID: string = "270701";
    private symName: string = "Minefield - Antipersonnel Mine";
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "AntiPersonnelMine");
     ...
     */
    public init(options: AntiPersonnelMineOptions, marker: SimpleLineSymbol): void {
        this._opacity = 1;
    ...
    private getImagePath(): string {
        ...
        const imageName = 'AntiPersonnelMine.png';
...
export default AntiPersonnelMine; 