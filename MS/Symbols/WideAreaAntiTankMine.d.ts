...
declare class WideAreaAntiTankMine {
    SID: string;
    symName: string;
    ...
    init(options: WideAreaAntiTankMineOptions, marker: SimpleLineSymbol | SimpleFillSymbol): void;
    createDrawEssentials(ctrlPts: Point[], drawType: number, opacity: number): DrawEssentials;
