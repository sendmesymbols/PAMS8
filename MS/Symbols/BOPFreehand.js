/**
 * Class Representing BOP / Post Free Area Filled.
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var BOPFreehand = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.BOPFreehand",
      SID: "160207",
      symName: "Post / BOP Freehand",
      ...
      init: function (options, marker) {
        ...
        c.a = 0.50;
        this._lineSym = new SimpleFillSymbol(SimpleFillSymbol.STYLE_SOLID, new SimpleLineSymbol(marker.style, marker.color, marker.width), c);
