/**
 * Class Representing Area Of Operations.
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var AreaOfOperations = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.AreaOfOperations",
      SID: "120100",
      symName: "Area of Ops",
      ...
      createInnerText: function (result, firstPoint, lastPoint) {
        ...
        try {
          ...
          var aa = Shapes.createAO(midPt.x, midPt.y, cLenLimit, midPt.spatialReference);
