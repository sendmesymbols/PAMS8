...
export interface FlightZoneOptions {
    CTRL_PTS?: Point[];
    GEOM?: Polygon;
    DRAW_TYPE?: number;
...
/**
 * FlightZone class for Flight Zone symbol
...
export class FlightZone {
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "FlightZone");
     ...
     */
    public init(options: FlightZoneOptions, marker: SimpleLineSymbol): void {
