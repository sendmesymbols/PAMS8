...
export interface FreehandMainAttackArrowOptions {
    CTRL_PTS?: Point[];
    GEOM?: Polygon;
    HEAD_RATIO?: number;
    TAIL_FACTOR?: number;
...
/**
 * FreehandMainAttackArrow class for drawing Freehand Main Attack Like Arrow symbols on MapView or SceneView
 * Supports both immediate placement and interactive drawing modes with inner arrow line
 */
export class FreehandMainAttackArrow {
    ...
    // Symbol properties
    private SID: string = "000008";
    private symName: string = "Freehand - Main Attk Like Arrow";
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "FreehandMainAttackArrow");
    ...
    /**
     * Initialize the freehand main attack arrow drawing
     */
    public init(options: FreehandMainAttackArrowOptions, marker: SimpleLineSymbol | SimpleFillSymbol): void {
    ...
    /**
     * Create arrow head path with inner line calculation
     */
    private CreateArrowHeadPathEx(
        ...
        return { 
            rings: ring, 
            midPtLeft: { x: intersectLineLeft.x, y: intersectLineLeft.y }, 
            midPtRight: { x: intersectLineRight.x, y: intersectLineRight.y }, 
...
export default FreehandMainAttackArrow; 