/**
 * Class Representing Assembly Area.
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
    ...
    "esri/geometry/webMercatorUtils", "esri/geometry/Polygon",    
    "dojo/on", "dojo/Evented", "esri/geometry/Point", 
    "MilSymbologyExt/GeoTools", "MilSymbologySymbolsEngine/DrawEssentials",
    "MilSymbologyComponents/Shapes"
  ],
  function (declare, lang, Array,
    _Graphic, jsonUtility,
    webMercatorUtils, _Polygon,    
    on, Evented, Point, 
    GeoTools, DrawEssentials,
    Shapes) {
    var MedevacMsnArea = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.MedevacMsnArea",
      SID: "25120617",
      ...
      init: function (options, marker) {
        ...
        if (options.hasOwnProperty("CTRL_PTS") && options.hasOwnProperty("GEOM")) {
          ...
          drawEssentials = this.createDrawEssentials(lang.clone(options.CTRL_PTS), options.DRAW_TYPE);
      ...
      createInnerText: function (result, firstPoint, lastPoint) {
        var res = result;
        try {
          var midPt = res.getExtent().getCenter();
          var cLenLimit;
          var baseLineLen = GeoTools._2PtLen(firstPoint, lastPoint);
          var cLenLimit = baseLineLen / 10;
          if (cLenLimit > baseLineLen / 3.6) cLenLimit = baseLineLen / 3.6;
          var aa = Shapes.createPlus(midPt.x, midPt.y, cLenLimit, midPt.spatialReference);
