...
export interface DoubleFenceWireOptions {
  CTRL_PTS?: Point[];
  GEOM?: Polyline;
  DRAW_TYPE?: number;
...
/**
 * DoubleFenceWire class for Double Fence symbol
 */
export class DoubleFenceWire {
  ...
  // Symbol metadata
  public declaredClass: string = "MilitarySymbology.Symbols.DoubleFenceWire";
  public SID: string = "290303";
  public symName: string = "Wire Obs - Double Fence Wire";
  ...
  constructor(view: MapView | SceneView, isLine: boolean = false) {
    ...
    this.events = new SymbolEvents(view, "DoubleFenceWire");
   ...
   */
  public init(options: DoubleFenceWireOptions, marker: SimpleLineSymbol): void {
  ...
  /**
   * Create symbol per legacy JS: add the control path and place symbols at intervals (SIDC '21')
   */
  private createSymbol(drawEssentials: DrawEssentials): Polyline | null {
    try {
      ...
      // Compute sampling gap like legacy
...
export default DoubleFenceWire;