 ...
 */
export class WideAreaAntiTankMine {
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "WideAreaAntiTankMine");
     ...
     */
    public init(options: WideAreaAntiTankMineOptions, marker: SimpleLineSymbol): void {
        this._opacity = 1;
