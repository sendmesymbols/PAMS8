...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var Delay = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.Delay",
      SID: "342400",
      symName: "Delay",
        ...
        try {
          ...
          if (pts.length === 2) {
            ...
            for (var i = 0; i < values.midPoints.length; i++) {
              ...
              result.addPath(Shapes.createDD(values.midPoints[i].midPt.x, values.midPoints[i].midPt.y, cLenLimit, this.map.spatialReference));
