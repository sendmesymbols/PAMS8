...
export interface FreehandLineDottedOptions {
    CTRL_PTS?: Point[];
    GEOM?: Polyline;
    DRAW_TYPE?: number;
    [key: string]: any;
...
/**
 * FreehandLineDotted class for drawing Freehand Line Dotted symbols on MapView or SceneView
 * Supports both immediate placement and interactive drawing modes with dotted line style
 */
export class FreehandLineDotted {
    ...
    // Symbol properties
    private SID: string = "000003";
    private symName: string = "Freehand - Line Dotted";
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "FreehandLineDotted");
    ...
    /**
     * Initialize the freehand line dotted drawing
     */
    public init(options: FreehandLineDottedOptions, marker: SimpleLineSymbol | SimpleFillSymbol): void {
        this._lineSym = marker;
        
        // Set dashed line style for dotted line
...
export default FreehandLineDotted; 