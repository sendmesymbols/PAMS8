/**
 * Class Representing Corps Administrative Area.
 * @class
 * @author Abdul Razak
 */
...
class Shapes {
  static createCAA(x: number, y: number, size: number, spatialRef: any): number[][][] {
...
interface CorpsAdmAreaOptions {
  CTRL_PTS?: Point[];
  GEOM?: Polygon;
  DRAW_TYPE?: number;
}

export default class CorpsAdmArea extends Evented {
  public declaredClass: string = "MilitarySymbology.Symbols.CorpsAdmArea";
  public SID: string = "150203";
  public symName: string = "Corps Adm Area";
  ...
  public init(options: CorpsAdmAreaOptions, marker: any): void {
  ...
  private createInnerText(result: Polygon, firstPoint: Point, lastPoint: Point): Polygon {
    try {
      ...
      if (extent && extent.center) {
        ...
        const rings = Shapes.createCAA(midPt.x, midPt.y, cLenLimit, midPt.spatialReference);
