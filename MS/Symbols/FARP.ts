...
/**
 * Forward Arming and Refueling Point area symbol.
 * Supports multiple drawing types: Bezier curve (1), Polygon (2), Rectangle (3)
 * Includes a geometric FARP label as part of the polygon geometry.
 */
export class FARP {
    ...
    // Symbol properties
    public declaredClass = "MilitarySymbology.Symbols.FARP";
    private SID: string = "310300";
    private symName: string = "Forward Arming and Refueling Point (FARP)";
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "FARP");
     ...
     */
    public init(options: FARPOptions, marker: SimpleLineSymbol): void {
    ...
    private createInnerText(result: Polygon, firstPoint: Point, lastPoint: Point): Polygon {
        try {
            ...
            const letterSize = cLenLimit * 0.75;
            const spacing = cLenLimit * 1.1;
            const strokes = [
                ...(Shapes as any).createFStrokes(midPt.x - spacing * 1.5, midPt.y, letterSize, midPt.spatialReference),
                ...(Shapes as any).createAStrokes(midPt.x - spacing * 0.5, midPt.y, letterSize, midPt.spatialReference),
