...
export class Block {
    ...
    // Symbol properties
    private SID: string = "340100";
    private symName: string = "Block";
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "Block");
     ...
     */
    public init(options: BlockOptions, marker: SimpleLineSymbol): void {
