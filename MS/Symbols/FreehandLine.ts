...
/**
 * FreehandLine class for drawing freehand line symbols on MapView or SceneView
...
export class FreehandLine {
    ...
    constructor(view: MapView | SceneView, isLine: boolean = false) {
        ...
        this.events = new SymbolEvents(view, "FreehandLine");
     ...
     */
    public init(options: FreehandLineOptions, marker: SimpleLineSymbol): void {
