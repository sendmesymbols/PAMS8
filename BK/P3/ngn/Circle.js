...
//>>built
define("esri/geometry/Circle", "dojo/_base/declare dojo/_base/lang dojo/has ../kernel ../lang ./Point ./Polygon ./geodesicUtils ./webMercatorUtils ../WKIDUnitConversion ../units".split(" "), function(h, m, q, r, n, s, l, t, p, k, u) {
    h = h(l, {
        ...
        constructor: function(a,
            ...
            this.center = m.isArray(b.center) ? new s(b.center[0], b.center[1]) : b.center;
            this.radius = b.radius || 1E3;
            this.radiusUnit = b.radiusUnit || u.METERS;
        ...
        _init: function() {
            ...
            if (this.geodesic) {
                ...
                switch (c) {
                    case "webMercator":
                        b =
                            p.webMercatorToGeographic(this.center);
                        break;
                    case "projected":
                ...
                "webMercator" === c && (a = p.geographicToWebMercator(a))
            } else {
                var d;
                ...
                a =
                    this._createPlanarCircle(this.center, d, this.numberOfPoints)
            }
        ...
        _createGeodesicCircle: function(a, c, b) {
            for (var d = 0, e = Math.PI / 180, f = [], g; d < 2 * Math.PI;) g = t._directGeodeticSolver(a.y * e, a.x * e, d, c), f.push([g.x, g.y]), d += Math.PI / (b / 2);
            f.push(f[0]);
            return new l(f)
        },
        _createPlanarCircle: function(a, c, b) {
            ...
            e.push(e[0]);
            a = new l(a.spatialReference);
            a.addRing(e);
            return a
        },
        _srType: function(a) {
            return a.isWebMercator() ? "webMercator" : n.isDefined(k[a.wkid]) || a.wkt && 0 === a.wkt.indexOf("PROJCS") ? "projected" : "geographic"
        },
        _convert2Meters: function(a, c) {
            var b;
            if (n.isDefined(k[c.wkid])) b = k.values[k[c.wkid]];
            else {
                b = c.wkt;
    ...
    q("extend-esri") && m.setObject("geometry.Circle", h, r);
    return h
});