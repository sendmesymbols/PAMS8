...
if (__thisIsNewer) {
    ...
    function $COOKIE(key, value, options) {
        ...
        for (var i = 0, len = arr.length; i < len; i++) {
            ...
            name = decodeURIComponent(parts[0].ltrim()),
            value = parts.length > 1 ? decodeURIComponent(parts[1].rtrim()) : null;
            cookies[name] = value;
            if (key && key == name) {
                return value;
            }
...
// play nice with kendo filter
if (typeof kendo != "undefined") {delete Object.prototype.contains;}