        ...
        var h = H(L, {
            ...
            _onMouseDownHandler: function(c) {
                ...
                switch (this._geometryType) {
                    ...
                    case d.FREEHAND_POLYGON:
                        this._oldPoint = c.screenPoint, b = new s(g), b.addRing(this._points), this._graphic = a.graphics.add(new t(b, this.fillSymbol), !0), a.snappingManager && a.snappingManager._setGraphic(this._graphic)
                }
            ...
            _onMouseDragHandler: function(c) {
                if (this._graphic || this._points.length)
                    if (r("esri-touch") &&
                        !this._points.length) c.preventDefault();
                    else {
                        this._dragged = !0;
                        var a;
                        this.map.snappingManager && (a = this.map.snappingManager._snappingPoint);
                        ...
                        switch (this._geometryType) {
                            ...
                            case l.RECTANGLE:
                                ...
                                break;
                            case l.LINE:
                                a.setGeometry(n.mixin(a.geometry, {
                                    paths: [
                                        [
                                            [b.x, b.y],
                                            [d.x, d.y]
            ...
            _onDblClickHandler: function(c) {
                ...
                var k = b[b.length - 1],
                    l = b[b.length - 2],
                    b = k && l && k.x === l.x && k.y === l.y ? b.slice(0,
            ...
            _updateTooltip: function(c) {
                ...
                if (a) {
                    ...
                    D.set(a, {
                        left: b + this._options.tooltipOffset + "px",
                        top: c + "px"
                    });
                    a.style.display = ""
                }
