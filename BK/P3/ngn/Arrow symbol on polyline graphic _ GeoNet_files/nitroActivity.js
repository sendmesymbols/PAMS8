...
jive.eae.digest.subItem.nitroActivity = function(opt_data, opt_sb) {
  ...
  if (opt_data.activity.groupedUsers && opt_data.activity.groupedUsers.length) {
    ...
    jive.shared.displayutil.userDisplayNameLink(soy.$$augmentMap(opt_data.activity.activityUser, {displayNameOverride: (opt_data.user.id == opt_data.activity.activityUser.id) ? soy.$$escapeHtml(jive.i18n.i18nText(jive.i18n.getMsg('k201a'),[])) : ''}), output);
  }
