    ...
    function (Map, FeatureLayer, GeometryService, Editor, TemplatePicker, config,
        ...
        ready(function () {
             ...
             */
             ...
             flFirePolygons = new FeatureLayer("http://20.60.50.32:6080/arcgis/rest/services/PolygonFeature/FeatureServer/0", {
                outFields: ['*']
            });
            ...
            function initEditor(results) {
                ...
                var lyrsInfo = array.map(results.layers, function (result) {
                    return {
                ...
                var editorSettings = {
                    ...
                    createOptions: {
                        polygonDrawTools: [Editor.CREATE_TOOL_POLYGON, Editor.CREATE_TOOL_FREEHAND_POLYGON, Editor.CREATE_TOOL_RECTANGLE, Editor.CREATE_TOOL_TRIANGLE, Editor.CREATE_TOOL_CIRCLE]
                    },
                    toolbarOptions: {
                        reshapeVisible: true
                    },
