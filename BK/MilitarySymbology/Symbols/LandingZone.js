...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var LandingZone = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.LandingZone",
      SID: "242304",
      symName: "Landing Zone",
      ...
      createInnerText: function (result, firstPoint, lastPoint) {
        ...
        try {
          ...
          var lz = Shapes.createLZ(midPt.x, midPt.y, cLenLimit, midPt.spatialReference);
          for (var j = 0; j <= lz.length - 1; j++) {
            res.addRing(lz[j]);
          }
