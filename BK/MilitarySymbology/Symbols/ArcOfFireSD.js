/**
 * Class Representing Arc Of Fire.
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var ArcOfFireSD = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.ArcOfFireSD",
      SID: "152300",
      symName: "Arc of Fire",
        ...
        try {
          ...
          if (pts.length === 2) {
            ...
            if (circle.radius > 0) {
              ...
              paths.push([pts[pts.length - 1].x, pts[pts.length - 1].y]);
