...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
    ...
    function (declare, lang, Array,
        ...
        var Boundary = declare([Evented], {
            declaredClass: "MilitarySymbology.Symbols.Boundary",
            SID: "110100",
            symName: "Boundary / Bdry",
            ...
            init: function (options, marker) {
                ...
                if (options.hasOwnProperty("CTRL_PTS") && options.hasOwnProperty("GEOM")) {
                    ...
                    drawEssentials = this.createDrawEssentials(lang.clone(options.CTRL_PTS), options.ECHELON);
            ...
            createDrawEssentials: function (ctrlPts, echelon) {
                var drawEssentials = new DrawEssentials();
            ...
            createSymbol: function (drawEssentials) {
                try {
                    ...
                    for (var i = 0; i < values.midPoints.length; i++) {
                        ...
                        /* Prev Values
                        var cLenLimit; 
                        var baseLineLen = GeoTools._2PtLen(pts[i], values.midPoints[i].midPt) / 7;
            ...
            cleanUp: function () {
                ...
                drawEss = this.createDrawEssentials(lang.clone(this._points), this._echelon);
