...
define(["dojo/_base/declare", "dojo/_base/lang", "esri/graphic", "esri/geometry/jsonUtils",
    ...
    "dojo/on", "dojo/Evented", "esri/geometry/Point", "MilSymbologyComponents/BaseLine",
    ...
    function (declare, lang, _Graphic, jsonUtility,
        ...
        on, Evented, Point, BaseLine, GeoTools, DrawEssentials,
        Shapes) {

        var Funnel = declare([Evented], {
            declaredClass: "MilitarySymbology.Symbols.Funnel",
            SID: "151407",
            symName: "Funnel",
            ...
            init: function (options, marker) {
                ...
                if (options.hasOwnProperty("CTRL_PTS") && options.hasOwnProperty("BASE_LN_PTS") && options.hasOwnProperty("GEOM")) {
                    ...
                    drawEssentials = this.createDrawEssentials(lang.clone(options.CTRL_PTS), lang.clone(options.BASE_LN_PTS), this.frontLineAgle, this.frontLineDist, this.flapDist);
            ...
            createDrawEssentials: function (ctrlPts, baseLinePts, frontLineAngleRatio, frontLineDistRatio, flapDistRatio) {
                var drawEssentials = new DrawEssentials();
            ...
            _onMMoveHdler: function (inputPoint) {
                ...
                drawEssentials.FRNT_LN_DIST_RATIO = this.frontLineDist;
                drawEssentials.FLAP_DIST_RATIO = this.flapDist;
            ...
            cleanUp: function () {
                ...
                drawEss = this.createDrawEssentials(lang.clone(this._points), lang.clone(this._baseLinePts), this.frontLineAgle, this.frontLineDist, this.flapDist);
