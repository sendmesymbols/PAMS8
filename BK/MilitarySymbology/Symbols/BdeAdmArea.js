/**
 * Class Representing Bde Administrative Area.
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var BdeAdmArea = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.BdeAdmArea",
      SID: "150207",
      symName: "Bde Adm Area",
      ...
      createInnerText: function (result, firstPoint, lastPoint) {
        ...
        try {
          ...
          var baa = Shapes.createBAA(midPt.x, midPt.y, cLenLimit, midPt.spatialReference);
          for (var j = 0; j <= baa.length - 1; j++) {
            res.addRing(baa[j]);
          }
          return res;
        } catch (e) {
