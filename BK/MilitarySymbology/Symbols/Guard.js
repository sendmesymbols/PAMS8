...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var Guard = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.Guard",
      SID: "342202",
      symName: "Guard",
      ...
      createSymbol: function (drawEssentials) {
        try {
          ...
          var values = Shapes.createG(cPt.x, cPt.y, cLenLimit, cPt.spatialReference);
          

          for (var i = 0; i < values.length; i++) {
            result.addPath(values[i]);
          }
          ...
          if (pts.length === 3) {
            ...
            values = Shapes.createG(cPt.x, cPt.y, cLenLimit, cPt.spatialReference);
