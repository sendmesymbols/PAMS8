...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var SlowGo = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.SlowGo",
      SID: "120202",
      symName: "Slow Go Area",
      ...
      init: function (options, marker) {
        ...
        c.a = 0.50;
        this._lineSym = new SimpleFillSymbol(SimpleFillSymbol.STYLE_VERTICAL, new SimpleLineSymbol(marker.style, marker.color, marker.width), c);
