...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var NoGo = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.NoGo",
      SID: "120203",
      symName: "No Go Area",
      ...
      init: function (options, marker) {
        ...
        c.a = 0.50;
        this._lineSym = new SimpleFillSymbol(SimpleFillSymbol.STYLE_CROSS, new SimpleLineSymbol(marker.style, marker.color, marker.width), c);
