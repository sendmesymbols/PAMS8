/**
 * Class Representing Area of Interest.
 * @class
 * @author Abdul Razak
 */
...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var ZoneOfResponsibility = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.ZoneOfResponsibility",
      SID: "241901",
      symName: "Zone of Responsibility",
      ...
      createInnerText: function (result, firstPoint, lastPoint) {
        ...
        try {
          ...
          var zor = Shapes.createZOR(midPt.x, midPt.y, cLenLimit, midPt.spatialReference);
          for (var j = 0; j <= zor.length - 1; j++) {
            res.addRing(zor[j]);
          }
          return res;
        } catch (e) {
