...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
  ...
  function (declare, lang, Array,
    ...
    var Cover = declare([Evented], {
      declaredClass: "MilitarySymbology.Symbols.Cover",
      SID: "342201",
      symName: "Covering Tps",
      ...
      createSymbol: function (drawEssentials) {
        try {
          ...
          result.addPath(Shapes.createCC(cPt.x, cPt.y, cLenLimit, this.map.sp));
          ...
          if (pts.length === 3) {
            ...
            result.addPath(Shapes.createCC(cPt.x, cPt.y, cLenLimit, this.map.spatialReference));
