...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array",
	...
	function (declare, lang, Array,
		...
		var LineOfNoPen = declare([Evented], {
			declaredClass: "MilitarySymbology.Symbols.LineOfNoPen",
			SID: "141901",
			symName: "Line Of No Pen",
			...
			createSymbol: function (drawEssentials) {
				try {
					...
					var paths = Shapes.createLNP(pt1.x, pt1.y, len / 2, map.spatialReference);
					...
					var paths = Shapes.createLNP(pt2.x + (len / 0.5), pt2.y, len / 2, map.spatialReference);
					for (var i = 0; i < paths.length; i++) {
						result.addPath(paths[i]);
					}
